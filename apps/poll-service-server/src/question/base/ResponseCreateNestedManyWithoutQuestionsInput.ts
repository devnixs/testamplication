...
@InputType()
class ResponseCreateNestedManyWithoutQuestionsInput {
...
export { ResponseCreateNestedManyWithoutQuestionsInput as ResponseCreateNestedManyWithoutQuestionsInput };
